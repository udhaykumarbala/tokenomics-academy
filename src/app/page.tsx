        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="flex flex-col justify-center">
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <Link 
                href="/simulator" 
                className="bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium py-3 px-6 rounded-lg transition-colors"
              >
                Try Simulator
              </Link>
            </div>
          ...
          <div className="bg-gray-100 rounded-xl p-8 flex flex-col">
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="text-blue-600 font-bold text-xl mb-2">1. Learn Concepts</div>
              <p>Start with bite-sized lessons on tokenomics fundamentals and advanced concepts.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="text-blue-600 font-bold text-xl mb-2">2. Experiment</div>
              <p>Use the simulator to adjust parameters and see how they affect token metrics over time.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="text-blue-600 font-bold text-xl mb-2">3. Master</div>
